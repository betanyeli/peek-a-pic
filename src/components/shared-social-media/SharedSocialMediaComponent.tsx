...
import { shareSocialMediaData } from '../../data/sharedSocialMediaData';
...
const SharedSocialMediaComponent = () => {
    ...
    const subtitle = "Share with your friends or better...\nGive feedback to the creator 🥰";
    return (
        <>
            ...
            <View style={styles.iconContainer}>
                {shareSocialMediaData.map(({ id, icon, url }: any) => {
                    return <IconButton testID='iconButton' key={id} mode='contained' icon={icon} onPress={() => { handleOpenUrl(url) }} />
                })}
            </View>
